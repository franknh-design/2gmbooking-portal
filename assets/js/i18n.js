...
(function () {
  ...
  const DICT = {
    nb: {
      ...
      // Send dørkode-knapp i banner (v3.10.24)
      "sendcode.btn":          "🔑 Send dørkode",
      "sendcode.title":        "Send dørkode på SMS",
      "sendcode.sub":          "Tast inn romnummer — koden hentes fra bookingen som ligger på rommet.",
      "sendcode.roomLabel":    "Romnummer",
      "sendcode.roomPlaceholder":"f.eks. 702",
      "sendcode.codeLabel":    "Dørkode",
      "sendcode.phoneLabel":   "Telefonnummer",
      "sendcode.phonePlaceholder":"+47…",
      "sendcode.searching":    "Søker …",
      "sendcode.sending":      "Sender …",
      "sendcode.success":      "✓ Dørkode sendt til {phone}",
      "sendcode.cancel":       "Avbryt",
      "sendcode.send":         "Send",
      "sendcode.noBookings":   "Ingen aktive eller kommende bookinger på dette rommet.",
      "sendcode.noDoorCode":   "Bookingen har ikke fått tildelt dørkode ennå.",
      "sendcode.lookupError":  "Kunne ikke slå opp rommet. Prøv igjen.",
      "sendcode.pickGuest":    "Flere gjester på dette rommet ({n}) — velg hvem som skal motta SMS:",
      "sendcode.guestLine":    "Gjest: {name} · {status}",
    ...
    en: {
      ...
      // Banner Send door code button (v3.10.24)
      "sendcode.btn":          "🔑 Send door code",
      "sendcode.title":        "Send door code by SMS",
      "sendcode.sub":          "Enter a room number — the code is fetched from the booking on that room.",
      "sendcode.roomLabel":    "Room number",
      "sendcode.roomPlaceholder":"e.g. 702",
      "sendcode.codeLabel":    "Door code",
      "sendcode.phoneLabel":   "Phone number",
      "sendcode.phonePlaceholder":"+47…",
      "sendcode.searching":    "Looking up …",
      "sendcode.sending":      "Sending …",
      "sendcode.success":      "✓ Door code sent to {phone}",
      "sendcode.cancel":       "Cancel",
      "sendcode.send":         "Send",
      "sendcode.noBookings":   "No active or upcoming bookings on this room.",
      "sendcode.noDoorCode":   "The booking has no door code assigned yet.",
      "sendcode.lookupError":  "Could not look up the room. Please try again.",
      "sendcode.pickGuest":    "Multiple guests on this room ({n}) — pick who should receive the SMS:",
      "sendcode.guestLine":    "Guest: {name} · {status}",
