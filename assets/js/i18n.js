...
(function () {
  ...
  const DICT = {
    nb: {
      ...
      "booking.projectNo":  "Prosjektnr / referanse (valgfritt)",
      "booking.projectNoPlaceholder":"Eks. P-1042 eller bestiller-ref",
      "booking.projectNoHint":"Vises på bekreftelsen og på fakturaen.",
      "booking.submit":     "Send bestilling",
      "booking.sending":    "Sender…",
      "booking.noLocations":"Ingen lokasjoner tilgjengelig",
      "booking.noneWholePeriod":"Ingen rom ledig hele perioden",
      "booking.nFreeWholePeriod":"{n} rom ledig hele perioden",
      "booking.someWholePeriod":"Bare {n} av {needed} rom ledig hele perioden",
      "booking.errNoRoomWholePeriod":"Ingen rom er ledige hele perioden. Prøv en kortere periode eller andre datoer.",
      "booking.locComing":"kommer snart",
      "booking.locClosed":"midlertidig stengt",
      "booking.locSomeClosed":"Lokasjoner som ikke er operative ennå kan ikke bestilles.",
      "booking.locNoneOpen":"Ingen av lokasjonene dine er klare for bestilling ennå. Ta kontakt med 2GM Eiendom.",
      "booking.errLocClosed":"Denne lokasjonen er ikke klar for bestilling ennå.",
      ...
      "mybookings.lblProjectNo":  "Prosjektnr",
    ...
    en: {
      ...
      "booking.projectNo":  "Project no / reference (optional)",
      "booking.projectNoPlaceholder":"E.g. P-1042 or your own ref",
      "booking.projectNoHint":"Shown on the confirmation and on the invoice.",
      "booking.submit":     "Submit booking",
      "booking.sending":    "Sending…",
      "booking.noLocations":"No locations available",
      "booking.noneWholePeriod":"No room free for the whole period",
      "booking.nFreeWholePeriod":"{n} rooms free for the whole period",
      "booking.someWholePeriod":"Only {n} of {needed} rooms free for the whole period",
      "booking.errNoRoomWholePeriod":"No room is free for the whole period. Try a shorter stay or different dates.",
      "booking.locComing":"coming soon",
      "booking.locClosed":"temporarily closed",
      "booking.locSomeClosed":"Locations that are not operational yet cannot be booked.",
      "booking.locNoneOpen":"None of your locations are ready for booking yet. Please contact 2GM Eiendom.",
      "booking.errLocClosed":"This location is not ready for booking yet.",
      ...
      "mybookings.lblProjectNo":  "Project no",
