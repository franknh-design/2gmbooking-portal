...
(function () {
  ...
  const DICT = {
    nb: {
      ...
      "auth.phoneLabel":      "Mobilnummer",
      "auth.phonePlaceholder":"+47 999 99 999",
      "auth.sendCode":        "Send kode på SMS",
      "auth.codeHint":        "Du mottar en 6-sifret engangskode.",
      "auth.codeLabel":       "Engangskode",
      "auth.codePlaceholder": "6 sifre",
      "auth.confirm":         "Bekreft og logg inn",
      "auth.changeNumber":    "← Endre nummer",
      "auth.skip":            "Hopp over (mock)",
      "auth.codeMustBe6":     "Koden må være 6 sifre.",
      "auth.mockHint":        "Mock-modus: skriv {code} — eller hva som helst på 6 sifre.",
    ...
    en: {
      ...
      "auth.phonePlaceholder":"+47 999 99 999",
      "auth.sendCode":        "Send code by SMS",
      "auth.codeHint":        "You will receive a 6-digit one-time code.",
      "auth.codeLabel":       "One-time code",
      "auth.codePlaceholder": "6 digits",
      "auth.confirm":         "Confirm and sign in",
      "auth.changeNumber":    "← Change number",
      "auth.skip":            "Skip (mock)",
      "auth.codeMustBe6":     "The code must be 6 digits.",
      "auth.mockHint":        "Mock mode: enter {code} — or any 6 digits.",
